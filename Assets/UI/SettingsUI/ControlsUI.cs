...
public class ControlsUI : MonoBehaviour
{
    ...
    private static readonly string[] FallbackActionNames = { "MoveLeft", "MoveRight", "Jump", "FirstSkill", "SecondSkill", "ThirdSkill", "FourthSkill", "FifthSkill", "SixthSkill", "Interact", "OpenInventory", "OpenSkillTree" };
